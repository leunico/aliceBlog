...
class Example extends Model
{
    ...
    public function setBind($table)
    {
        
        $this->tableinit = $this->tablename;
        $this->tablename = $table;
        return $this;
    ...
    public function clear()
    {
        ...
        $this->where_ = $this->order_ = $this->group_ = $this->limit_ = '';
        empty($this->tableinit) ?: $this->tablename = $this->tableinit;
