...
class JinShan {
	...
	public function PutImgContent($filename,$content,$width=1000){
		...
		return $ret['ETag'] ? $this->CombinationUrl($filename,$width) : false;
	}
	
	public function PutImgFile($filename,$filepath,$width=1000){
	...
	public function CombinationUrl($filename,$width){
		
		return 	"http://".$this->bucket.".kssws.ks-cdn.com/".$filename.JINSHAN_DIR_THUMB.$width;	
