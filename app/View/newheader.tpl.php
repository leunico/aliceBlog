...
<meta name="apple-mobile-web-app-title" content="<?php echo SEO_TITLE?>">
<meta http-equiv="Cache-Control" content="no-siteapp">
<title><?php echo $seo_title ? $seo_title.'-'.SEO_TITLE : SEO_TITLE;?></title>
<link rel='stylesheet' id='_bootstrap-css'  href='<?php echo CSS_DIR?>bootstrap.min.css?ver=1446654712' type='text/css' media='all' />
<link rel='stylesheet' id='_main-css'  href='<?php echo CSS_DIR?>main.css?ver=1446654712' type='text/css' media='all' />
<script type='text/javascript' src='<?php echo JS_DIR?>jquery.min.js?ver=1446654712'></script>
<meta name="keywords" content="<?php echo $seo_keywords ? $seo_keywords : SEO_KEYWORDS;?>">
<meta name="description" content="<?php echo $seo_description ? $seo_description : SEO_DESCRIPTION;?>">
<style>
...
<?php echo $css ? "<link rel=\"stylesheet\" href=".CSS_DIR.$css.">":""; ?>
<?php echo $js ? "<script type='text/javascript' src=".JS_DIR.$js."></script>":""; ?>
</head>
